...
// import div from "components/MKTypography";

// Otis Kit PRO components
// import ColoredBackgroundCard from "examples/Cards/BackgroundCards/ColoredBackgroundCard";
// import img from "examples/Cards/BackgroundCards/img";

function BlogPostOne() {
    return (
        <div component="section" py={2}>
            <Container>
                <Grid
                    container
                    item
                    ...
                    mb={6}
                >
                    <div py={2} px={6} textAlign="center">
                        <div
                            width="4rem"
                            height="4rem"
                            display="flex"
                        ...
                        <div variant="h2" mt={2} mb={1}>
                            Check out what&apos;s new
                        </div>
                        <div variant="body2" color="text">
